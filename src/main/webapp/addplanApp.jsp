                ...
                <form action="/app/plan/add" method="post">
                    <div class="row border-bottom border-3 p-1 m-1">
                        ...
                        <div class="col d-flex justify-content-end mb-2 noPadding">
                            <button type="submit" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4" id="save">Zapisz</button>
                            <button type="button" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4 ml-1" id="cancel">Anuluj</button>
                        </div>
                    </div>
